...
#if defined(__NEED___off_t) && !defined(__DEFINED___off_t)
...
#if defined(__NEED___gid_t) && !defined(__DEFINED___gid_t)
typedef uint32_t __gid_t;
#define __DEFINED___gid_t
#endif

#if defined(__NEED___pid_t) && !defined(__DEFINED___pid_t)
...
#if defined(__NEED_cpusetid_t) && !defined(__DEFINED_cpusetid_t)
typedef int cpusetid_t;
#define __DEFINED_cpusetid_t
#endif

#if defined(__NEED_cpulevel_t) && !defined(__DEFINED_cpulevel_t)
typedef int cpulevel_t;
#define __DEFINED_cpulevel_t
#endif

#if defined(__NEED_cpuwhich_t) && !defined(__DEFINED_cpuwhich_t)
typedef int cpuwhich_t;
#define __DEFINED_cpuwhich_t
#endif
