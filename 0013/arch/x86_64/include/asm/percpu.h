...
#define __my_cpu_number		this_cpu_read(cpu_number)
#define arch_this_cpu_number()    __my_cpu_number
#define arch_raw_cpu_ptr(ptr) \
({                                                      \
        unsigned long tcp_ptr__=this_cpu_read(this_cpu_off)+(unsigned long)ptr;    \
        (typeof(*(ptr)) __kernel __force *)tcp_ptr__;   \
})


#define arch_raw_cpu_ptr2(ptr)                           \
({                                                      \
