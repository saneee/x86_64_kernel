...
local str = "GET /json HTTP/1.0ddddd1dd"
local split3=function (s,p)
    return {yaos.split(s,p)}
end
local start = yaos.uptime();
local arr = split3(str,"dd");
local endtime = yaos.uptime();
yaos.show_dump(arr);
local endtime2 = yaos.uptime();
yaos.say(start.."#"..endtime.."#"..endtime2.."#"..(endtime2-start).."\n");
