...
extern void virtio_set_queue_callback(virtio_dev_t dev, int qidx, void (*callback)(void * data,size_t len));
extern int virtio_read_queue(virtio_dev_t dev, int qidx);
extern bool virtio_parse_pci_config(virtio_dev_t p);
...
extern void virtio_queue_disable_intr(struct virtio_queue *q);
extern void virtio_queue_enable_intr(struct virtio_queue *q);
#endif
