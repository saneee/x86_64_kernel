...
#define pci_d(...) inline_printk(__VA_ARGS__)
#define pci_w(...) inline_printk(__VA_ARGS__)
struct pci_device {
    struct device dev;
    u8 _bus;
    u8 _device;
...
extern void pci_msi_enable(pci_device_t pci);
extern void pci_msi_disable(pci_device_t pci);
extern void pci_dump_config(pci_device_t pci);
struct msi_msg;
bool pci_msi_write_entry(pci_device_t pci, int entry_id, struct msi_msg *msg);
bool pci_msix_write_entry(pci_device_t pci, int entry_id, struct msi_msg *msg);
